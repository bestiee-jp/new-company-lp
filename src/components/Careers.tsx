    ...
    <section className="bg-white" style={{ paddingTop: '80px', paddingBottom: '80px', position: 'relative', overflow: 'hidden' }}>
      ...
      >
        <defs>
          <linearGradient id="lineGradient1" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="rgba(30, 90, 168, 0.4)" />
            <stop offset="100%" stopColor="rgba(77, 217, 217, 0.4)" />
          </linearGradient>
          <linearGradient id="lineGradient2" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="rgba(0, 163, 224, 0.25)" />
            <stop offset="100%" stopColor="rgba(77, 217, 217, 0.25)" />
          </linearGradient>
        </defs>
        <path
      ...
      <div
        style={{
          ...
          height: '120px',
          borderRadius: '50%',
          background: 'linear-gradient(135deg, rgba(0, 163, 224, 0.3) 0%, rgba(77, 217, 217, 0.1) 100%)',
          zIndex: 0,
        }}
      />
      <div
