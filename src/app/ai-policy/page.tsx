    ...
    <main className="min-h-screen flex flex-col">
      ...
      <section style={{ backgroundColor: 'white', padding: '60px 5%', flex: 1 }}>
        <div style={{ maxWidth: '900px', margin: '0 auto', lineHeight: '1.8', color: '#333' }}>
          <h2 style={{ fontSize: '20px', fontWeight: 'bold', marginBottom: '24px', borderLeft: '4px solid #4dd9d9', paddingLeft: '12px' }}>前文</h2>
          <p style={{ marginBottom: '16px' }}>
            株式会社bestieeは、「学びと出会いに、ワクワクを」をミッションに掲げ、人生の分岐点に立つ人々の「不安」を「熱狂」へ、「退屈」を「期待」へと変えていくことを目指しています。
          </p>
          <p style={{ marginBottom: '16px' }}>
            私たちは、AI面接練習・採用マッチングサービス「FastPass」、AIを活用した家庭教師マッチングサービス「ベストティーチ」など、AIを事業の中核に据えたサービスを提供しています。AIの力を活用することで、就職活動や学習における一人ひとりの可能性を最大限に引き出し、より良い出会いと成長の機会を創出することを目指しています。
          </p>
          <p style={{ marginBottom: '24px' }}>
            私たちは、AIの健全な発展に貢献するとともに、以下のポリシーのもとで、責任あるAIの技術開発・利用に取り組んでまいります。
          </p>

          <h2 style={{ fontSize: '20px', fontWeight: 'bold', marginTop: '40px', marginBottom: '16px', borderLeft: '4px solid #4dd9d9', paddingLeft: '12px' }}>1. 人間中心の原則</h2>
          <p style={{ marginBottom: '16px' }}>
          ...
          <h2 style={{ fontSize: '20px', fontWeight: 'bold', marginTop: '40px', marginBottom: '16px', borderLeft: '4px solid #4dd9d9', paddingLeft: '12px' }}>2. 教育・リテラシーの原則</h2>
          <p style={{ marginBottom: '16px' }}>
          ...
          <h2 style={{ fontSize: '20px', fontWeight: 'bold', marginTop: '40px', marginBottom: '16px', borderLeft: '4px solid #4dd9d9', paddingLeft: '12px' }}>3. プライバシー保護の原則</h2>
          <p style={{ marginBottom: '16px' }}>
          ...
          <h2 style={{ fontSize: '20px', fontWeight: 'bold', marginTop: '40px', marginBottom: '16px', borderLeft: '4px solid #4dd9d9', paddingLeft: '12px' }}>4. セキュリティ確保の原則</h2>
          <p style={{ marginBottom: '16px' }}>
          ...
          <h2 style={{ fontSize: '20px', fontWeight: 'bold', marginTop: '40px', marginBottom: '16px', borderLeft: '4px solid #4dd9d9', paddingLeft: '12px' }}>5. 公平性の尊重</h2>
          <p style={{ marginBottom: '16px' }}>
          ...
          <h2 style={{ fontSize: '20px', fontWeight: 'bold', marginTop: '40px', marginBottom: '16px', borderLeft: '4px solid #4dd9d9', paddingLeft: '12px' }}>6. 透明性と説明責任の原則</h2>
          <p style={{ marginBottom: '16px' }}>
            私たちは、AIの判断根拠は透明であるべきだと考えます。AI面接の評価やフィードバックについて、その根拠をできる限り明確に説明できるよう努めます。また、AIの限界についても誠実に伝え、ユーザーがAIの出力を適切に理解し活用できるよう支援します。
          </p>

          <h2 style={{ fontSize: '20px', fontWeight: 'bold', marginTop: '40px', marginBottom: '16px', borderLeft: '4px solid #4dd9d9', paddingLeft: '12px' }}>7. 継続的な改善</h2>
          <p style={{ marginBottom: '16px' }}>
